...
class ControllerExtensionModuleDvtabcategory extends Controller
{
    public function index($setting) {
        $this->load->language('diva/module/dvtabcategory');
        ...
        if (isset($setting['second_image']) && $setting['second_image']) {
            $data['show_second_image'] = true;
        } else {
            $data['show_second_image'] = false;
        }
        ...
        if(isset($setting['product_category']) && $setting['product_category']) {
            $pro_categories = $setting['product_category'];
        } else {
            $pro_categories = array();
        }

        if($pro_categories) {
            foreach ($pro_categories as $category_id) {
        ...
        return $this->load->view('diva/module/dvtabcategory', $data);
    }
}