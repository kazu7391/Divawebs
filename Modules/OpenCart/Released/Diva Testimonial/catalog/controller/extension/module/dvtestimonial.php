...
class ControllerExtensionModuleDvtestimonial extends Controller
{
    public function index($setting) {
        ...
        $testimonial_total = $this->model_diva_testimonial->getTotalTestimonials();
        ...
        $results = $this->model_diva_testimonial->getTestimonials(0, $limit);
        if($results) {
        ...
        return $this->load->view('diva/module/dvtestimonial', $data);
    }
}