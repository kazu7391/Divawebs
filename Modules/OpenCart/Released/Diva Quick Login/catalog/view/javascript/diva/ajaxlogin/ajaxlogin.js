...
var dvlogin = {
            ...
            success: function (json) {
                if(json['success'] == true) {
                    if(json['enable_redirect']) {
                        ...
                        $('.dv-account').load('index.php?route=diva/login/headerHtml #top-links ul.dv-account li');
    ...
    'registerAction' : function () {
        ...
        $.ajax({
            url: 'index.php?route=diva/register/register',
            type: 'post',
    ...
    'logoutAction' : function () {
        $.ajax({
            url: 'index.php?route=diva/login/logout',
            dataType: 'json',
            beforeSend: function () {
