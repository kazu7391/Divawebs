<?php
class ControllerDivaLogin extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $data['action'] = $this->url->link('diva/login/login', '', true);
        ...
        return $this->load->view('diva/quicklogin/login', $data);
}
