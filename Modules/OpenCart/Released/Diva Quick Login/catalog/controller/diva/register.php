<?php
class ControllerDivaRegister extends Controller {

    private $error = array();

    public function index() {
        $this->load->language('diva/register');
        ...
        $data['action'] = $this->url->link('diva/register', '', true);
        ...
        return $this->load->view('diva/quicklogin/register', $data);
    }
    ...
    public function success() {
        ...
        return $this->load->view('diva/quicklogin/success', $data);
    }
