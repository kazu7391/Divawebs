...
class ControllerExtensionModuleDvblog extends Controller
{
    public function index($setting) {
        ...
        $results = $this->model_diva_blog->getPostsByList($filter_data, $setting['list']);
        ...
        foreach ($results as $result) {
            $data['posts'][] = array(
                ...
                'href'        => $this->url->link('diva/blog/post', 'post_id=' . $result['post_id'])
            );
        }
        ...
        return $this->load->view('diva/module/dvblog', $data);
    }
}