...
class ControllerExtensionModuleDvtestimonial extends Controller
{
    ...
    public function index() {
        $this->load->language('extension/module/dvtestimonial');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if (!isset($this->request->get['module_id'])) {
                $this->model_setting_module->addModule('dvtestimonial', $this->request->post);
            } else {
        ...
        if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            ...
            $data['action'] = $this->url->link('extension/module/dvtestimonial', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
        }
        ...
        $this->response->setOutput($this->load->view('diva/module/dvtestimonial', $data));
    }

    private function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/dvtestimonial')) {
    ...
    public function install() {
        $this->load->model('diva/testimonial');
        $this->model_diva_testimonial->install();
    }

    public function uninstall() {
        $this->load->model('diva/testimonial');
        $this->model_diva_testimonial->uninstall();
    }
}