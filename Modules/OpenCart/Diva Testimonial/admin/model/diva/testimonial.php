...
class ModelDivaTestimonial extends Model
{
    public function addTestimonial($data) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "dvtestimonial SET status = '" . (int) $this->request->post['status'] . "', sort_order = '" . (int) $this->request->post['sort_order'] . "'");
    ...
    public function editTestimonial($testimonial_id, $data) {
        $this->db->query("UPDATE " . DB_PREFIX . "dvtestimonial SET status = '" . (int) $this->request->post['status'] . "', sort_order = '" . (int) $data['sort_order'] . "' WHERE dvtestimonial_id = '" . (int) $testimonial_id . "'");
    ...
    public function deleteTestimonial($testimonial_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "dvtestimonial WHERE dvtestimonial_id = '" . (int) $testimonial_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "dvtestimonial_description WHERE dvtestimonial_id = '" . (int) $testimonial_id . "'");
    ...
    public function getTestimonial($testimonial_id) {
        $query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "dvtestimonial t LEFT JOIN " . DB_PREFIX . "dvtestimonial_description td ON (t.dvtestimonial_id = td.dvtestimonial_id) WHERE t.dvtestimonial_id = '" . (int) $testimonial_id . "' ");
        return $query->row;
    }

    public function getTestimonials($data = array()) {
        if ($data) {
            $sql = "SELECT * FROM " . DB_PREFIX . "dvtestimonial_description td LEFT JOIN " . DB_PREFIX . "dvtestimonial t ON (t.dvtestimonial_id = td.dvtestimonial_id)";
            ...
            if (!$testimonial_data) {
                $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "dvtestimonial t LEFT JOIN " . DB_PREFIX . "dvtestimonial_description td ON (t.dvtestimonial_id = td.dvtestimonial_id) ORDER BY td.customer_name ASC");
    ...
    public function getTestimonialDescriptions($testimonial_id) {
        ...
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "dvtestimonial_description WHERE dvtestimonial_id = '" . (int) $testimonial_id . "'");
    ...
    public function getTotalTestimonials() {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "dvtestimonial");
    ...
    public function uninstall() {
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "dvtestimonial`");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "dvtestimonial_description`");
