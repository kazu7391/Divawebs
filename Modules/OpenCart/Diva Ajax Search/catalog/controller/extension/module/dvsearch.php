...
class ControllerExtensionModuleDvsearch extends Controller
{
    public function index() {
        $this->load->language('diva/module/dvsearch');
        ...
        $data['search_ajax_action'] = $this->url->link('extension/module/dvsearch/ajaxSearch', '', true);

        $data['ajax_enabled'] = (int) $this->config->get('module_dvsearch_ajax');
        ...
        return $this->load->view('diva/search/form', $data);
    }
    ...
    public function ajaxSearch() {
        ...
        if(($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $data['product_img_enabled'] = (int) $this->config->get('module_dvsearch_show_img');
            $data['product_price_enabled'] = (int) $this->config->get('module_dvsearch_show_price');

            $json['result_html'] = $this->load->view('diva/search/ajaxresult', $data);
