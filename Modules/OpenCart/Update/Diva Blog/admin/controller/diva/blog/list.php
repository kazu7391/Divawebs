...
class ControllerDivaBlogList extends Controller
{
    ...
    public function getForm() {
        ...
        if (isset($this->request->post['post_list_description'])) {
            ...
            $data['post_list_description'] = $this->model_diva_blog->getPostListDescriptions($this->request->get['post_list_id']);
        } else {
        ...
        if (isset($this->request->post['post_list_store'])) {
            ...
            $data['post_list_store'] = $this->model_diva_blog->getPostListStores($this->request->get['post_list_id']);
        } else {
